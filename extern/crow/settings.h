#pragma once
// settings for crow
// TODO(ipkn) replace with runtime config. libucl? Retained for compatibility
// with upstream Crow configuration options.
...
/* #ifdef - disables static directory functionality to avoid template compilation issues */
