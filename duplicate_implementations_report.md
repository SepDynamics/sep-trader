...
- Unused multi-asset signal fusion and enhanced market cache modules removed (`src/app/multi_asset_signal_fusion.*`, `src/app/enhanced_market_model_cache.*`, `src/app/market_regime_adaptive.hpp`, tests under `tests/signal_fusion/`).
